...
from app.mappings import FKExternalMapping, PrimaryKey, datetime_tz, numeric_10_3
...
class DataPointSeries(BaseDbModel):
    ...
    __table_args__ = (
        Index("idx_data_point_series_mapping_type_time", "external_mapping_id", "series_type", "recorded_at"),
    )
